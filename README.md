...
- **Setup is a conversation, in your language.** The first message asks, in English and Urdu, whether the ledger is personal or for a shop. Whichever you answer in becomes your language for eight numbered questions and every fixed reply after; a one-line note says `/lang` switches it. Hisab is written in English and اردو; write to it in Roman Urdu and it answers in Roman Urdu.
...
5. Send your agent any message. It asks personal or shop (in English and Urdu, answer in either), then seven more numbered questions in that language, writes your chart of accounts, and posts what you sent.
