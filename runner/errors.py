...
The portal renders `portal_error_<code>` through t() in en/ur/roman (landing/content/strings.json), so
the three-language rule is not smuggled around by putting English into a database.
