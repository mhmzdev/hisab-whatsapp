...
| [`tests/fixtures/receipts/README.md`](../tests/fixtures/receipts/README.md) | you are placing the blurred receipt photos for `tests/check_receipts.py` (what each must show, the blurring rule) |
